-- ============================================
-- Werewolf Game Database Schema (FIXED)
-- MySQL 8.0+
-- Đã sửa lỗi foreign key constraint trong bảng matches
-- ============================================
...
-- FIXED: room_id phải là NULL để tương thích với ON DELETE SET NULL
-- ============================================
